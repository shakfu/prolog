...
extern "C" int luaopen_prolog(lua_State* L ) {
    sol::state_view lua(L);


    // vehicle class
    sol::usertype<model::Vehicle> vehicle_type = lua.new_usertype<model::Vehicle>("Vehicle", 
    ...
    // process class
    sol::usertype<core::Process> process_type = lua.new_usertype<core::Process>("Process", 
        sol::constructors<sol::types<>>());
